...
<html>
  ...
  <body>
    ...
    <section data-bs-version="5.1" class="form6 cid-tgN756Npvs" id="form6-13">
      <div class="container">
        ...
        <div class="row justify-content-center mt-4">
          <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
            <form
              action="./actions/consulta-marcada.php"
              method="POST"
              class="mbr-form form-with-styler mx-auto"
              data-form-title="Marcar Reserva"
            >
              <div class="dragArea row">
                ...
                >
                  <input 
                    type="date" 
                    name="data-consulta"
                    id="data-form6-13 data-consulta"
                    class="form-control"
                ...
                >
                  <input 
                    type="time" 
                    name="hora-consulta" 
                    id="hora-form6-13 hora-consulta" 
                    class="form-control"
                    data-form-field="time"
                  />
                </div>
                <div
                  data-for="valor"
                ...
                >
                  <input 
                    type="text" 
                    name="valor-consulta" 
                    id="hora-form6-13 valor-consulta" 
                    class="form-control"
                    data-form-field="valor"
